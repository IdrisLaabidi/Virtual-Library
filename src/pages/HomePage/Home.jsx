...
import LPimg1 from '../../assets/landingPageImg1.jpeg';
import LPimg2 from '../../assets/login.jpeg';
    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-blue-500 dark:bg-gray-900">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg mb-8 text-white">Discover, borrow, and read thousands of books online</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-700">Borrow books instantly and enjoy reading on any device.</p>
            </div>
            <div className="text-center">
              <svg className="w-12 h-12 mx-auto mb-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path>
          ...
          <div className="text-center">
            <img src={LPimg1} alt="Featured Book" className="mx-auto mb-4 max-w-lg" />
          </div>
        </div>
      </section>
      {/* Steps to use App Section */}
        <section className='container mx-auto py-16 text-gray-800 dark:text-gray-900'>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <img src={LPimg2} alt="Featured Book" className="mx-auto mt-[-45px] mb-4 max-w-lg" />
                </div>
                <div>
        ...
        <div className="container mx-auto text-center">
            ...
            <div className="bg-white shadow-md rounded-lg p-6 dark:text-gray-800">
                <blockquote className="text-lg mb-4">"Virtual Library has an amazing selection of books. The borrowing process is seamless and convenient." - John Smith</blockquote>
